...
const EnrollmentAnalytics = () => {
  ...
  const { pdfLoading, chartPdfLoading, handleDownloadPDF, handleDownloadWithCharts } =
    usePdfDownload(selectedYear, CHART_LABELS, 'enrollments');
  ...
  return (
    <motion.div className="metrics-container" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <nav className="breadcrumbs">
        ...
        <span className="breadcrumb-sep">›</span>
        <span className="breadcrumb-item breadcrumb-inactive">Enrollments</span>
        <span className="breadcrumb-sep">›</span>
        <span className="breadcrumb-item breadcrumb-active">Enrollment Analytics</span>
      </nav>
